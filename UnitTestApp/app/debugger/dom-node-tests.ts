import {
    attachCSSInspectorCommandCallbacks, attachDOMInspectorCommandCallbacks,
    attachDOMInspectorEventCallbacks, InspectorCommands, InspectorEvents
} from 'tns-core-modules/debugger/devtools-elements';

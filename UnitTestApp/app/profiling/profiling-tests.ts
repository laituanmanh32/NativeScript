import {
    disable, enable, isRunning, profile, resetProfiles, start, stop, time, timer
} from 'tns-core-modules/profiling';

import { assert, assertEqual, assertFalse, assertNull, assertThrows, assertTrue } from '../tk-unit';
